...
import { setLoadingNewPageCondition, setSelectedCard } from '../actions'
...
export default function Minicard(props) {
    ...
    return (
        <div className="card">
          <Link href={`/card?title=${props.id}`}><h1 onClick={() => dispatch(setLoadingNewPageCondition())} class="topic">{props.title}</h1></Link>
          <hr />
