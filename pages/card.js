        ...
        <center>
            <div className="bigCard">
                ...
                <Link href={`/edit?title=${card._id}`}>
                  <svg onClick={() => dispatch(setLoadingNewPageCondition())} className="edit" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
